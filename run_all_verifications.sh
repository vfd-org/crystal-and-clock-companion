...
set -uo pipefail
cd "$(dirname "$0")"
suites=(explore_mode_counting explore_offset_rationals explore_geometric_ladder explore_shell_rule verify_sm_structure verify_crystal_forcing verify_rendering_layer verify_rung_dimension_ladder \
