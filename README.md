...
| `explore_shell_rule.py` | 10 | the shell-rule attack: proof-grade refutation of static-feature rules, look-elsewhere-corrected nulls, the scheme-dependence gradient, one out-of-sample-failed lead |
